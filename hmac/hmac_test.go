...
func TestSha256(t *testing.T) {
	...
	if Sha256("secret", "test", "base64") != "Aymga2LNFrM+tnkr6MYLFY2Jou46h2/Omogeu0iMCRQ=" {
		t.Errorf("Sha256(test, \"base64\"), expect %s, but got %s", "Aymga2LNFrM+tnkr6MYLFY2Jou46h2/Omogeu0iMCRQ=", Sha256("secret", "test", "base64"))
	}
...
func TestSha512(t *testing.T) {
	...
	if Sha512("secret", "test", "base64") != "+KTwogkWe8GSob/6oB7NsJ4GxX+WUw2S7JzOoAkNKQ5VBxMG1rZU8mrgyHIffkii1xMLiBFR8s7I1h2UGmvoig==" {
		t.Errorf("Sha512(test, \"base64\"), expect %s, but got %s", "+KTwogkWe8GSob/6oB7NsJ4GxX+WUw2S7JzOoAkNKQ5VBxMG1rZU8mrgyHIffkii1xMLiBFR8s7I1h2UGmvoig==", Sha512("secret", "test", "base64"))
	}
...
func TestSha224(t *testing.T) {
	...
	if Sha224("secret", "test", "base64") != "piUvphacXIkxHuzToBISfg2fXahsvWG/wQJhyg==" {
		t.Errorf("Sha224(test, \"base64\"), expect %s, but got %s", "piUvphacXIkxHuzToBISfg2fXahsvWG/wQJhyg==", Sha224("secret", "test", "base64"))
	}
...
func TestSha384(t *testing.T) {
	...
	if Sha384("secret", "test", "base64") != "TlSpe+lH5HHonN0iwluP9wT0WP3869inmjZv8OUrYH/j8eUr0ag5+JOW0aSyy+Vw" {
		t.Errorf("Sha384(test, \"base64\"), expect %s, but got %s", "TlSpe+lH5HHonN0iwluP9wT0WP3869inmjZv8OUrYH/j8eUr0ag5+JOW0aSyy+Vw", Sha384("secret", "test", "base64"))
	}
